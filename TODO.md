...
En face du seuil, case à cocher pour le tealent compétent.
...
## Niveau
Liste des choses à vérifier en montant de niveau : PV, PA, usuels métiers, seuil de défense.

## Legacy
mettre dans une section à la fin les champs qui ne sont plus utilisés, mais qu’il faut garder pour la rétrocompatibilité.
Origine, Métiers (dans les traits en haut).
Historique.

# Mode vue
Se rapprocher le plus possible de la feuille papier.
Mettre des icones pour PV (et pv temp, pv aggr), def, mouvement, save

## Boutons
Boutons de carac ont un style différent si le perso a pris le talent compétent.
Boutons pour jets de dés simples : d20, d8, d4.
